...
class AggregEventAnalysisEngIntegTest extends BaseTest {
	...
	public async test1_DP1() {
		...
		//is empty
		await this.assertEventsAndAttacks(0, 0, AggregEventAnalysisEngIntegTest.criteria.get("all")!);
		...
		await this.generateEvents(this.sleepAmount * 3, 
                            ...
                            3, 
                            "rule1");
		await this.assertEventsAndAttacks(3, 1, AggregEventAnalysisEngIntegTest.criteria.get("dp1")!);
		...
		await this.generateEvents(this.sleepAmount, 
                            ...
                            1,
                            "rule1");
		await this.assertEventsAndAttacks(4, 1, AggregEventAnalysisEngIntegTest.criteria.get("dp1")!);
		...
		await this.generateEvents(this.sleepAmount * 2, 
                            ...
                            2, 
                            "rule1");
		await this.assertEventsAndAttacks(6, 2, AggregEventAnalysisEngIntegTest.criteria.get("dp1")!);
		attacks = await this.appSensorServer!.getAttackStore()!.findAttacks(AggregEventAnalysisEngIntegTest.criteria.get("rule1")!);
	...
	public async test2_DP1andDP2() {
		...
		await this.generateEvents(this.sleepAmount * 3, 
                            ...
                            "rule2");
		await this.assertEventsAndAttacks(3, 1, AggregEventAnalysisEngIntegTest.criteria.get("dp1")!);
		await this.assertEventsAndAttacks(0, 0, AggregEventAnalysisEngIntegTest.criteria.get("rule2")!);

		await this.generateEvents(this.sleepAmount * 12, 
                            AggregEventAnalysisEngIntegTest.detectionPoint2, 
                            12, 
                            "rule2");
		await this.assertEventsAndAttacks(12, 1, AggregEventAnalysisEngIntegTest.criteria.get("dp2")!);
		await this.assertEventsAndAttacks(0, 1, AggregEventAnalysisEngIntegTest.criteria.get("rule2")!);
		...
		await this.assertEventsAndAttacks(13, 1, AggregEventAnalysisEngIntegTest.criteria.get("dp2")!);
		await this.assertEventsAndAttacks(0, 1, AggregEventAnalysisEngIntegTest.criteria.get("rule2")!);
		...
		await this.assertEventsAndAttacks(24, 2, AggregEventAnalysisEngIntegTest.criteria.get("dp2")!);
		await this.assertEventsAndAttacks(0, 1, AggregEventAnalysisEngIntegTest.criteria.get("rule2")!);

		await this.generateEvents(this.sleepAmount*2, AggregEventAnalysisEngIntegTest.detectionPoint1, 2, "rule2");
		await this.assertEventsAndAttacks(6, 2, AggregEventAnalysisEngIntegTest.criteria.get("dp1")!);
		await this.assertEventsAndAttacks(0, 2, AggregEventAnalysisEngIntegTest.criteria.get("rule2")!);
		...
		await this.generateEvents(this.sleepAmount*3, AggregEventAnalysisEngIntegTest.detectionPoint1, 3, "rule2");
		await this.assertEventsAndAttacks(12, 4, AggregEventAnalysisEngIntegTest.criteria.get("dp1")!);
		await this.assertEventsAndAttacks(0, 2, AggregEventAnalysisEngIntegTest.criteria.get("rule2")!);
	...
	public async test3_DP1orDP2() {
		...
		await this.assertEventsAndAttacks(3, 1, AggregEventAnalysisEngIntegTest.criteria.get("dp1")!);
		await this.assertEventsAndAttacks(0, 1, AggregEventAnalysisEngIntegTest.criteria.get("rule3")!);

		await this.generateEvents(this.sleepAmount*12, AggregEventAnalysisEngIntegTest.detectionPoint2, 12, "rule3");
		await this.assertEventsAndAttacks(12, 1, AggregEventAnalysisEngIntegTest.criteria.get("dp2")!);
		await this.assertEventsAndAttacks(0, 2, AggregEventAnalysisEngIntegTest.criteria.get("rule3")!);
		...
		await this.assertEventsAndAttacks(24, 2, AggregEventAnalysisEngIntegTest.criteria.get("dp2")!);
		await this.assertEventsAndAttacks(0, 3, AggregEventAnalysisEngIntegTest.criteria.get("rule3")!);
	...
	public async test4_DP1orDP2andDP3() {
		...
		await this.assertEventsAndAttacks(3, 1, AggregEventAnalysisEngIntegTest.criteria.get("dp1")!);
		await this.assertEventsAndAttacks(0, 1, AggregEventAnalysisEngIntegTest.criteria.get("rule4")!);

		//DP1 - trigger attack
		await this.generateEvents(this.sleepAmount*3, AggregEventAnalysisEngIntegTest.detectionPoint1, 3, "rule4");
		await this.assertEventsAndAttacks(6, 2, AggregEventAnalysisEngIntegTest.criteria.get("dp1")!);
		await this.assertEventsAndAttacks(0, 2, AggregEventAnalysisEngIntegTest.criteria.get("rule4")!);
		...
		await this.assertEventsAndAttacks(13, 1, AggregEventAnalysisEngIntegTest.criteria.get("dp3")!);
		await this.assertEventsAndAttacks(0, 2, AggregEventAnalysisEngIntegTest.criteria.get("rule4")!);

		await this.generateEvents(this.sleepAmount*12, AggregEventAnalysisEngIntegTest.detectionPoint2, 12, "rule4");
		await this.assertEventsAndAttacks(12, 1, AggregEventAnalysisEngIntegTest.criteria.get("dp2")!);
		await this.assertEventsAndAttacks(0, 3, AggregEventAnalysisEngIntegTest.criteria.get("rule4")!);

		//DP1 - trigger attack
		await this.generateEvents(this.sleepAmount*3, AggregEventAnalysisEngIntegTest.detectionPoint1, 3, "rule4");
		await this.assertEventsAndAttacks(9, 3, AggregEventAnalysisEngIntegTest.criteria.get("dp1")!);
		await this.assertEventsAndAttacks(0, 4, AggregEventAnalysisEngIntegTest.criteria.get("rule4")!);

		//DP3 no new attack
		await this.generateEvents(this.sleepAmount*13, AggregEventAnalysisEngIntegTest.detectionPoint3, 13, "rule4");
		await this.assertEventsAndAttacks(26, 2, AggregEventAnalysisEngIntegTest.criteria.get("dp3")!);
		await this.assertEventsAndAttacks(0, 4, AggregEventAnalysisEngIntegTest.criteria.get("rule4")!);

		//DP1 - trigger attack
		await this.generateEvents(this.sleepAmount*3, AggregEventAnalysisEngIntegTest.detectionPoint1, 3, "rule4");
		await this.assertEventsAndAttacks(12, 4, AggregEventAnalysisEngIntegTest.criteria.get("dp1")!);
		await this.assertEventsAndAttacks(0, 5, AggregEventAnalysisEngIntegTest.criteria.get("rule4")!);
	...
	public async test5_DP1thenDP2() {
		...
		await this.assertEventsAndAttacks(3, 1, AggregEventAnalysisEngIntegTest.criteria.get("dp1")!);
		await this.assertEventsAndAttacks(0, 0, AggregEventAnalysisEngIntegTest.criteria.get("rule5")!);

		//DP2 - trigger attack
		await this.generateEvents(this.sleepAmount*12, AggregEventAnalysisEngIntegTest.detectionPoint2, 12, "rule5");
		await this.assertEventsAndAttacks(12, 1, AggregEventAnalysisEngIntegTest.criteria.get("dp2")!);
		await this.assertEventsAndAttacks(0, 1, AggregEventAnalysisEngIntegTest.criteria.get("rule5")!);

		//DP2 - no attack
		await this.generateEvents(this.sleepAmount*11, AggregEventAnalysisEngIntegTest.detectionPoint2, 11, "rule5");
		await this.assertEventsAndAttacks(23, 1, AggregEventAnalysisEngIntegTest.criteria.get("dp2")!);
		await this.assertEventsAndAttacks(0, 1, AggregEventAnalysisEngIntegTest.criteria.get("rule5")!);
	...
	public async test6_DP1thenDP2thenDP1orDP2() {
		...
		await this.assertEventsAndAttacks(3, 1, AggregEventAnalysisEngIntegTest.criteria.get("dp1")!);
		await this.assertEventsAndAttacks(0, 0, AggregEventAnalysisEngIntegTest.criteria.get("rule6")!);
		...
		//DP2 - no attack
		await this.generateEvents(this.sleepAmount*12, AggregEventAnalysisEngIntegTest.detectionPoint2, 12, "rule6");
		await this.assertEventsAndAttacks(48, 4, AggregEventAnalysisEngIntegTest.criteria.get("dp2")!);
		await this.assertEventsAndAttacks(0, 1, AggregEventAnalysisEngIntegTest.criteria.get("rule6")!);
